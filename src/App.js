...
class App extends React.Component {
  ...
  render() {
    return (
      <Container>
        <Row context={this.context} samples={this.samples.slice(0, 5)} />
        <Row context={this.context} samples={this.samples.slice(5, 10)} />
        <Row context={this.context} samples={this.samples.slice(10, 15)} />
      </Container>
    )
  }
}
